...
\item
  If you're sick, please take time off, stay home (if we are in person), and take care of yourself. Just email the lab manager or me (Bridget) to tell us. Because you need it, and also because others don't need to get sick.
\item
...
\tightlist
\item
  Help collect data for the lab's projects
\item
  Recruitment?
\item
...
\hypertarget{enrolled-research-intern}{%
\section{Enrolled Research Intern}\label{enrolled-research-intern}}
